  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "has-focus:border-ring border-input relative rounded-md border shadow-xs has-focus:ring-[3px] has-focus:ring-ring/50",
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full flex-1 select-none p-0 text-center",
