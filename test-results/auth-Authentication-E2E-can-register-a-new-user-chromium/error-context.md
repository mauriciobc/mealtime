...
- Name: Authentication E2E >> can register a new user
- Location: /home/mauriciobc/Documentos/Code/mealtime/e2e/auth.spec.ts:24:3
...
Call log:
  - waiting for getByLabel('Password')
    ...
    at /home/mauriciobc/Documentos/Code/mealtime/e2e/auth.spec.ts:28:39
```
...
- main:
  ...
  - text: Email
  - textbox "Email": user1747428434201@example.com
  - text: Senha
  - textbox "Senha"
