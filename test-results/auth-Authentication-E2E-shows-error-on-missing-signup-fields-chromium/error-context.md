...
- Name: Authentication E2E >> shows error on missing signup fields
- Location: /home/mauriciobc/Documentos/Code/mealtime/e2e/auth.spec.ts:43:3
...
Call log:
  - waiting for getByRole('button', { name: /sign up|register|cadastrar/i })

    at /home/mauriciobc/Documentos/Code/mealtime/e2e/auth.spec.ts:45:77
```
