...
- Name: Authentication E2E >> can login with valid credentials
- Location: /home/mauriciobc/Documentos/Code/mealtime/e2e/auth.spec.ts:49:3
...
Call log:
  - waiting for getByLabel('Password')
    ...
    at registerTestUser (/home/mauriciobc/Documentos/Code/mealtime/e2e/auth.spec.ts:10:37)
    at /home/mauriciobc/Documentos/Code/mealtime/e2e/auth.spec.ts:50:5
```
...
- alert
- main:
  - text: MealTime Crie sua conta para começar Nome Completo
  ...
  - textbox "Confirme sua senha"
  - button "Criar conta com Email"
  - text: Ou continue com
  - button "Criar conta com Google":
    - img
