...
- Name: Authentication E2E >> login page loads and form is present
- Location: /home/mauriciobc/Documentos/Code/mealtime/e2e/auth.spec.ts:17:3
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /login/i })
    ...
    at /home/mauriciobc/Documentos/Code/mealtime/e2e/auth.spec.ts:19:65
```
