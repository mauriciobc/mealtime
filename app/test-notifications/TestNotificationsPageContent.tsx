          ...
          <form onSubmit={handleSchedule} className="flex flex-col gap-4">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 flex flex-col gap-2">
                <label htmlFor={idScheduleType} className="text-sm font-medium">Tipo</label>
                <select
                  id={idScheduleType}
                  name="type"
                  value={form.type}
              ...
              <div className="flex-1 flex flex-col gap-2">
                <label htmlFor={idScheduleTitle} className="text-sm font-medium">Título</label>
                <input
                  id={idScheduleTitle}
                  name="title"
                  value={form.title}
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor={idScheduleMessage} className="text-sm font-medium">Mensagem</label>
              <textarea
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 flex flex-col gap-2">
                <label htmlFor={idScheduleDeliverAt} className="text-sm font-medium">Data/Hora de Entrega</label>
                <input
              ...
              <div className="flex-1 flex flex-col gap-2">
                <label htmlFor={idScheduleCatId} className="text-sm font-medium">Cat ID (opcional)</label>
                <input
                  id={idScheduleCatId}
                  name="catId"
                  value={form.catId}
