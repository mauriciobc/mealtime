  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {[1, 2, 3].map((slot) => (
          <Card key={`skeleton-${slot}`} className="w-full">
            <CardHeader>
...
export default function HouseholdsPageContent() {
  ...
  const householdsToDisplay = Array.isArray(households) ? households : [];
          ...
          {householdsToDisplay.length === 0 ? (
            ...
            >
              {householdsToDisplay.map((household) => {
                ...
                return (
                  <m.div key={household.id} variants={itemVariants}>
