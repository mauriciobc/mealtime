...
import { useProfile, type ProfileData } from "@/lib/hooks/useProfile";
...
export default function ProfilePageClient() {
  ...
  const { data: profile, isLoading: loading, error: queryError } = useProfile(currentUser?.id);
  const [activeTab, setActiveTab] = useState("info");

  const error = queryError ? (queryError instanceof Error ? queryError.message : "Erro ao carregar perfil") : null;
