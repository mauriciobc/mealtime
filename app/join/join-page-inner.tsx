...
export function JoinPageInner({ initialInviteCode }: { initialInviteCode: string }) {
  ...
  const [editedInviteCode, setEditedInviteCode] = useState<string | null>(null);
  const inviteCode = editedInviteCode ?? initialInviteCode;
  ...
  const handleJoinHousehold = async () => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Ocorreu um erro ao tentar entrar no domicílio.");
    } finally {
      setIsLoading(false);
